  ...
  useEffect(() => {
    const getFriends = async () => {
      try {
        ...
        const friendList = await axios.get(`http://localhost:8800/api/user/friendlist/${user._id}`,{
          headers: {
    ...
    return (
      <>
        <div className="birthdayContainer">
          <img className="birthdayImg" src={require("../../Assets/gift.png")} alt="" />
          <span className="birthdayText">
            <b>Pola Foster</b> and <b>3 other friends</b> have a birhday today.
          </span>
        </div>
        <img className="rightbarAd" src={require("../../Assets/ad.jpg")} alt="" />
      </>
    );
  };
